...
// configuration step. It creates a namespace called `cpp_jam_game`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        cpp_jam_game::cmake::project_name,
        cpp_jam_game::cmake::project_version));// version string, acquired
